...
override PG_CXXFLAGS += -std=c++17 -I./include -I./pixels-common/include -I./pixels-core/include -I./pixels-proto -I./third-party/protobuf/src -I./third-party/protobuf/cmake/build/include 
